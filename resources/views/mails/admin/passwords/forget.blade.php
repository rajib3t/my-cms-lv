...
<head>
<title>{{ __('Admin Password Reset') }}|{{ config('app.name', 'Laravel') }}</title>
<meta charset="utf-8"/>
...
<div align="center" style="line-height:10px">{{ Html::image('admin-design/assets/mails/images/animated_header.gif','',['class'=>'big','style'=>'display: block; height: auto; border: 0; width: 600px; max-width: 100%;','width'=>600]) }}</div>
</td>
</tr>
</table>
</td>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d9dffa; background-image: url({{ asset('admin-design/assets/mails/images/body_background_2.png') }}); background-position: top center; background-repeat: repeat;" width="100%">
<tbody>
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; width: 600px;" width="600">
...
<p style="margin: 0; font-size: 14px;"><strong><span style="font-size:38px;">{{ __('Forgot your password?') }}</span></strong></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px;"><span style="font-size:16px;">{{ __('Hey, we received a request to reset your password.') }}</span></p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
<p style="margin: 0; font-size: 14px;"><span style="font-size:16px;">{{ __('Let’s get you a new one!') }}</span></p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
{{-- <p style="margin: 0; font-size: 14px;"><span style="font-size:14px;">Having trouble? <a href="#" rel="noopener" style="text-decoration: none; color: #40507a;" target="_blank" title="@socialaccount"><strong>@socialaccount</strong></a></span></p> --}}
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
<p style="margin: 0; font-size: 14px;">{{ __('Didn’t request a password reset? You can ignore this message.') }}</p>
</div>
</div>
</td>
</tr>
...
<tr>
<td style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" style="line-height:10px">{{ Html::image('assets/mails/images/bottom_img.png','',['class'=>'big','style'=>'display: block; height: auto; border: 0; width: 600px; max-width: 100%;','width'=>'600']) }}</div>
</td>
</tr>
</table>
</td>
...
<tr>
<td>
<div align="center" style="line-height:10px"><a href="{{ url('/') }}" style="outline:none" tabindex="-1" target="_blank">{{ Html::image('assets/mails/images/logo.png','',['class'=>'big','style'=>'display: block; height: auto; border: 0; width: 145px; max-width: 100%;','width'=>'145']) }}</a></div>
</td>
</tr>
</table>
...
{{-- <p style="margin: 0; font-size: 14px; text-align: center;">{{ __('+(123) 456–7890') }}</p> --}}
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #97a2da; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
{{-- <p style="margin: 0; font-size: 14px; text-align: center;">{{ __('This link will expire in the next 24 hours.')}}<br/>{{ __('Please feel free to contact us at email@ehichscroll.com.')  }} </p> --}}
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #97a2da; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
<p style="margin: 0; text-align: center; font-size: 12px;"><span style="font-size:12px;">{{ __('Copyright©') }} {{ date('Y') }} {{ config('app.name', 'Laravel') }}.</span></p>
{{-- <p id="m_8010100107078456808text01" style="margin: 0; text-align: center; font-size: 12px;"><span style="font-size:12px;"><a href="#" rel="noopener" style="text-decoration: underline; color: #97a2da;" target="_blank" title="Unsubscribe ">Unsubscribe</a> | <a href="#" rel="noopener" style="text-decoration: underline; color: #97a2da;" target="_blank" title="Manage your preferences">Manage your preferences</a> | <a href="#" rel="noopener" style="text-decoration: underline; color: #97a2da;" target="_blank" title="Privacy Policy">Privacy Policy</a></span></p> --}}
</div>
</div>
</td>
</tr>
