<x-admin-layout>
    ...
    <div class="row mt-4">
        ...
        <div class="col-sm-2">
            @include('admin.users.admin.settings.partials.nav')
        </div>
        <div class="col-sm-10">
            <div class="card">
                <div class="card-header pb-0">
                    <h6>{{ __('Admin General Setting') }}</h6>
                </div>
                <div class="card-body">
                    {{ Form::open(['route'=>'admin.user.admin.setting.general.update','method'=>'POST','id'=>'setting']) }}
                    <div class="row p-2">
                        <div class="col-md-6">
                            <div class="form-group">
                                {{ Form::label('admin_per_page_pagination','Admin Per Page Pagination') }}
                                {{ Form::number('admin_per_page_pagination',Setting::admin_setting_get('admin_per_page_pagination'),$errors->has('admin_per_page_pagination')?['id'=>'admin_per_page_pagination','class'=>'form-control is-invalid','placeholder'=>'10']:['id'=>'admin_per_page_pagination','class'=>'form-control','placeholder'=>'10']) }}
                            </div>
                        </div>
